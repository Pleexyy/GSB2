...
public class Database {
	...
	public static void connexionBdd() {
		try {
			...
			connexion = DriverManager.getConnection("jdbc:mysql://172.16.250.8/gsb2?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","sio","slam");
